...
public class VistaEditorialSwing implements WindowListener{
	
	private Controlador controlador;
	private DefaultTableModel modeloTabla;
	
	public VistaEditorialSwing(Controlador controlador) {
	...
	public void initGUIComponents() {
		...
		JFrame marco = new JFrame("SWING: Mostrar Editoriales.");
		marco.setSize(300, 200);
		marco.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		marco.setLocationRelativeTo(null);
		
		JLabel titulo = new JLabel("   Listado de Editoriales:");
