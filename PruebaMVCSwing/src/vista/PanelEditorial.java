...
public class PanelEditorial implements ActionListener, 
									KeyListener,
	...
	public PanelEditorial(JFrame marco, Controlador controlador) {
	...
	private void modificarRegistro() {
		...
		String feedBack = controlador.actualizarEditorial((int)tabla.getValueAt(tabla.getSelectedRow(), 0), textoNuevo.getText());
		//
		if (feedBack.equals("Modificación de editorial correcta.")) {
	...
	private void modificarRegistro(int claveModificacion, String valorModificacion, int fila, int columna) {
		...
		String pregunta = "Ha modificado el nombre de la editorial cuyo código es: " + claveModificacion + "\n¿Está seguro?";
		String feedBack = "No se ha modificado la editorial.";
		if (preguntarUsuario(pregunta) == JOptionPane.YES_OPTION) {
			feedBack = controlador.actualizarEditorial(claveModificacion, valorModificacion);
		}
		else {
	...
	private void borrarRegistro() {
		...
		String pregunta = "Va a borrar la editorial con código: " + tabla.getValueAt(tabla.getSelectedRow(), 0) + "\n¿Está seguro?";
		String feedBack = "No se ha borrado la editorial.";
		if (preguntarUsuario(pregunta) == JOptionPane.YES_OPTION) {
			feedBack = controlador.eliminarEditorial((int)tabla.getValueAt(tabla.getSelectedRow(), 0));
			//
			if (feedBack.equals("Se ha borrado la editorial.")) {
	...
	private void registrarNuevo() {
		...
		informarUsuario(controlador.insertarEditorial(textoNuevo.getText()));
